  ...
  createVendor = () => {
    ...
    API.createMenu(menuObj)
      .then((reply) => {
        ...
        console.log("This is the reply: ", reply, reply.data.id);
        console.log("Type of ID", typeof reply.data.id);
        let newVendor = {
                    ...
                    <Form>
                      ...
                      <FormGroup>
                        <Input
                          ...
                          defaultValue={
                            this.state.vendor.city ? this.state.vendor.city : ""
                          }
                        />
                      </FormGroup>
                      <FormGroup>
